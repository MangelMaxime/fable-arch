...
function remove$1(item$$1, map$$1) {
    return from$1(map$$1.comparer, tree_remove(map$$1.comparer, item$$1, map$$1.tree));
}
...
function mapEventHandler(mapping, e, f) {
    return new Types$1.Attribute("EventHandler", [[e, function ($var1) {
        return mapping(f($var1));
    }]]);
}
function mapAttributes(mapping, attribute) {
    return attribute.Case === "Style" ? new Types$1.Attribute("Style", [attribute.Fields[0]]) : attribute.Case === "Property" ? new Types$1.Attribute("Property", [attribute.Fields[0]]) : attribute.Case === "Attribute" ? new Types$1.Attribute("Attribute", [attribute.Fields[0]]) : mapEventHandler(mapping, attribute.Fields[0][0], attribute.Fields[0][1]);
}
...
function map$$1(mapping, node) {
    return node.Case === "VoidElement" ? new Types$1.DomNode("VoidElement", [mapVoidElem(mapping, node.Fields[0][0], node.Fields[0][1])]) : node.Case === "Text" ? new Types$1.DomNode("Text", [node.Fields[0]]) : node.Case === "WhiteSpace" ? new Types$1.DomNode("WhiteSpace", [node.Fields[0]]) : node.Case === "Svg" ? new Types$1.DomNode("Element", [mapElem(mapping, node.Fields[0][0], node.Fields[0][1]), map$1(function (node_1) {
        return map$$1(mapping, node_1);
    }, node.Fields[1])]) : new Types$1.DomNode("Element", [mapElem(mapping, node.Fields[0][0], node.Fields[0][1]), map$1(function (node_1) {
        return map$$1(mapping, node_1);
    }, node.Fields[1])]);
}
...
var Events = function (__exports) {
    var onMouseEvent = __exports.onMouseEvent = function (eventType, f) {
        ...
        return new Types$1.Attribute("EventHandler", [[eventType, h]]);
    };
...
var Types$$1 = function (__exports) {
  var Gender = __exports.Gender = function () {
    function Gender(caseName, fields) {
    ...
    _createClass(Gender, [{
      ...
      value: function () {
        return {
          type: "WebApp.Common.Types.Gender",
          interfaces: ["FSharpUnion", "System.IEquatable", "System.IComparable"],
          cases: {
            Female: [],
            Male: []
  ...
  setType("WebApp.Common.Types.Gender", Gender);
  ...
  var State = __exports.State = function () {
    ...
    _createClass(State, [{
      ...
      value: function () {
        return {
          type: "WebApp.Common.Types.State",
          interfaces: ["FSharpUnion", "System.IEquatable", "System.IComparable"],
          cases: {
            Active: [],
            Inactive: []
  ...
  setType("WebApp.Common.Types.State", State);

  var UserRecord = __exports.UserRecord = function () {
    function UserRecord(firstname, surname, age, email, gender, state) {
    ...
    _createClass(UserRecord, [{
      ...
      value: function () {
        return {
          type: "WebApp.Common.Types.UserRecord",
  ...
  setType("WebApp.Common.Types.UserRecord", UserRecord);
  return __exports;
}({});
var VDom = function (__exports) {
  var Types_1 = __exports.Types = function (__exports) {
...
var navButtons = Tags.span(ofArray([Attributes.classy("nav-item")]))(ofArray([navButton("fable", "http://fable.io/", "fa-github", "Fable"), navButton("twitter", "https://twitter.com/FableCompiler", "fa-twitter", "Twitter"), navButton("github", "https://github.com/fable-compiler/fable-arch", "fa-github", "Fork me")]));
...
function view$2(model) {
  return Tags.section(ofArray([Attributes.classy("hero is-primary")]))(ofArray([Tags.div(ofArray([Attributes.classy("hero-body")]))(ofArray([Tags.div(ofArray([Attributes.classy("container")]))(ofArray([Tags.h1(ofArray([Attributes.classy("title")]))(ofArray([Tags.text("Documentation")])), Tags.h2(ofArray([Attributes.classy("subtitle"), Attributes.property("innerHTML", "Everything you need to create a website using <strong>Fable Arch<strong>")]))(new List$1())]))])), footer(model)]));
}
...
setType("WebApp.Menu.Model", Model$3);
...
setType("WebApp.Menu.Actions", Actions$3);
var MenuLink = function () {
  function MenuLink(text, route) {
  ...
  _createClass(MenuLink, [{
    ...
    key: "Create",
    value: function (text, route) {
      return new MenuLink(text, route);
    }
  }]);

  return MenuLink;
}();
setType("WebApp.Menu.MenuLink", MenuLink);
...
function menuListItem(menuLink, currentPage) {
  var class_ = Attributes.classList(ofArray([["is-active", menuLink.Route.Equals(currentPage)]]));
  return Tags.li(new List$1())(ofArray([Tags.a(ofArray([class_, voidLinkAction(), Events.onMouseClick(function (_arg1) {
    return new Actions$3("NavigateTo", [menuLink.Route]);
  })]))(ofArray([Tags.text(menuLink.Text)]))]));
}
function menuList(items, currentPage) {
  return Tags.ul(ofArray([Attributes.classy("menu-list")]))(map$1(function (x) {
    return menuListItem(x, currentPage);
  }, items));
}
function menuSection(txt) {
  return Tags.p(ofArray([Attributes.classy("menu-label")]))(ofArray([Tags.text(txt)]));
}
function view$3(model) {
  return Tags.aside(ofArray([Attributes.classy("menu")]))(ofArray([menuSection("Users"), menuList(new List$1(), model.CurrentPage)]));
}
...
setType("WebApp.Pages.Index.Model", Model$4);
var Actions$4 = function () {
  ...
  _createClass(Actions, [{
    ...
    value: function () {
      return {
        type: "WebApp.Pages.Index.Actions",
        interfaces: ["FSharpUnion", "System.IEquatable", "System.IComparable"],
        cases: {
          NoOp: []
        }
...
setType("WebApp.Pages.Index.Actions", Actions$4);
...
function view$4(model) {
  ...
  return Tags.div(ofArray([Attributes.classy("section")]))(ofArray([Tags.div(ofArray([Attributes.classy("container")]))(ofArray([Tags.div(ofArray([Attributes.classy("content"), Attributes.property("innerHTML", marked.parse(index))]))(new List$1())]))]));
}
...
setType("WebApp.Pages.About.Model", Model$5);
var Actions$5 = function () {
  ...
  _createClass(Actions, [{
    ...
    value: function () {
      return {
        type: "WebApp.Pages.About.Actions",
        interfaces: ["FSharpUnion", "System.IEquatable", "System.IComparable"],
        cases: {
          NoOp: []
        }
...
setType("WebApp.Pages.About.Actions", Actions$5);
function update$5(model, action) {
  return [model, new List$1()];
}
function view$5(model) {
  return Tags.div(new List$1())(ofArray([Tags.text("About")]));
}
...
var map$4 = createCommonjsModule(function (module) {
module.exports = { "default": map$5, __esModule: true };
});

var _Map = unwrapExports(map$4);
...
var StoreItem = function () {
  ...
  _createClass(StoreItem, [{
    ...
    value: function () {
      return {
        type: "Herebris.SimpleDatabase.StoreItem",
        interfaces: ["FSharpRecord", "System.IEquatable", "System.IComparable"],
        properties: {
          Id: "number",
    ...
    key: "ExtractValue",
    value: function (item$$1, _genArgs) {
      return item$$1.Value;
    }
  }]);
...
setType("Herebris.SimpleDatabase.StoreItem", StoreItem);
var Store = function () {
  function Store(rows) {
  ...
  _createClass(Store, [{
    ...
    value: function () {
      return {
        type: "Herebris.SimpleDatabase.Store",
        interfaces: ["FSharpRecord", "System.IEquatable", "System.IComparable"],
        properties: {
          Rows: makeGeneric(List$1, {
            T: makeGeneric(StoreItem, {
              T: GenericParam("T")
            })
          })
        }
    ...
    key: "Create",
    value: function () {
      return new Store(new List$1());
    }
  }]);

  return Store;
}();
setType("Herebris.SimpleDatabase.Store", Store);
var StoreMeta = function () {
  function StoreMeta(name, id) {
    _classCallCheck(this, StoreMeta);

    this.Name = name;
    this.Id = id;
  }

  _createClass(StoreMeta, [{
    key: _Symbol.reflection,
    value: function () {
      return {
        type: "Herebris.SimpleDatabase.StoreMeta",
        interfaces: ["FSharpRecord", "System.IEquatable", "System.IComparable"],
        properties: {
          Name: "string",
          Id: "number"
    ...
    key: "Create",
    value: function (name) {
      return new StoreMeta(name, 0);
    }
  }]);

  return StoreMeta;
}();
setType("Herebris.SimpleDatabase.StoreMeta", StoreMeta);
var DatabaseRecord = function () {
  function DatabaseRecord(metadatas, stores) {
    _classCallCheck(this, DatabaseRecord);

    this.Metadatas = metadatas;
    this.Stores = stores;
  }

  _createClass(DatabaseRecord, [{
    key: _Symbol.reflection,
    value: function () {
      return {
        type: "Herebris.SimpleDatabase.DatabaseRecord",
        interfaces: ["FSharpRecord", "System.IEquatable"],
        properties: {
          Metadatas: makeGeneric(_Map, {
            TKey: "string",
            TValue: StoreMeta
          }),
          Stores: makeGeneric(_Map, {
            TKey: "string",
            TValue: makeGeneric(Store, {
              T: Any
            })
          })
        }
    ...
    key: "Create",
    value: function () {
      return new DatabaseRecord(new _Map(), new _Map());
    }
  }]);

  return DatabaseRecord;
}();
setType("Herebris.SimpleDatabase.DatabaseRecord", DatabaseRecord);
var SimpleDatabase = function () {
  _createClass(SimpleDatabase, [{
    key: _Symbol.reflection,
    value: function () {
      return {
        type: "Herebris.SimpleDatabase.SimpleDatabase",
        properties: {}
      };
    }
  }]);
  ...
  function SimpleDatabase() {
    _classCallCheck(this, SimpleDatabase);

    this.db = DatabaseRecord.Create();
  }

  _createClass(SimpleDatabase, [{
    key: "CreateStore",
    value: function (_genArgs) {
      var storeName = getTypeFullName(_genArgs.S, "name");

      if (!this.db.Metadatas.has(storeName)) {
        this.db.Metadatas.set(storeName, StoreMeta.Create(storeName));
        this.db.Stores.set(storeName, Store.Create());
      } else {
        fsFormat("Store: %s already exist")(function (x) {
          throw new Error(x);
        })(storeName);
      }
    }
    ...
    value: function (item$$1, _genArgs) {
      ...
      try {
        this.db.Stores.get(storeName).Rows = new List$1(new StoreItem(this.db.Metadatas.get(storeName).NextId, item$$1), this.db.Stores.get(storeName).Rows);
      } catch (matchValue) {
        fsFormat("Store: %s not found")(function (x) {
          throw new Error(x);
        })(storeName);
      }
    }
    ...
    key: "Get",
    value: function (id, _genArgs) {
      var storeName = getTypeFullName(_genArgs.S, "name");

      try {
        try {
          return StoreItem.ExtractValue(find(function (x) {
            return x.Id === id;
          }, this.db.Stores.get(storeName).Rows), {
            T: _genArgs.S,
            a: Any
          });
        } catch (matchValue) {
        ...
        return fsFormat("Store: %s not found")(function (x) {
          throw new Error(x);
        })(storeName);
      }
    }
    ...
    key: "GetItems",
    value: function (action, _genArgs) {
      var storeName = getTypeFullName(_genArgs.S, "name");
    ...
    value: function (_genArgs) {
      ...
      try {
        return map$1(function (x) {
          return StoreItem.ExtractValue(x, {
            T: _genArgs.S,
            a: Any
          });
        }, this.db.Stores.get(storeName).Rows);
    ...
    key: "Set",
    value: function (id, item$$1, _genArgs) {
      var storeName = getTypeFullName(_genArgs.S, "name");
...
setType("Herebris.SimpleDatabase.SimpleDatabase", SimpleDatabase);

var Setup = function (__exports) {
  var patients = __exports.patients = ofArray([new Types$$1.UserRecord("John", "Doe", 24, "john.doe@mail.com", new Types$$1.Gender("Male", []), new Types$$1.State("Active", [])), new Types$$1.UserRecord("Jane", "Doe", 27, "jane.doe@mail.com", new Types$$1.Gender("Female", []), new Types$$1.State("Active", [])), function () {
    var Firstname = "Barry";
    var Surname = "Magium";
    var Email = "barry.magium@mail.com";
    return new Types$$1.UserRecord(Firstname, Surname, 24, Email, new Types$$1.Gender("Male", []), new Types$$1.State("Inactive", []));
  }()]);
  return __exports;
}({});
...
var UserRes = function () {
  function UserRes(caseName, fields) {
    _classCallCheck(this, UserRes);

    this.Case = caseName;
    this.Fields = fields;
  }

  _createClass(UserRes, [{
    key: _Symbol.reflection,
    value: function () {
      return {
        type: "WebApp.FakeApi.UserRes",
        interfaces: ["FSharpUnion", "System.IEquatable", "System.IComparable"],
        cases: {
          Create: [],
          Delete: [],
...
setType("WebApp.FakeApi.UserRes", UserRes);
var Ressources = function () {
  function Ressources(caseName, fields) {
  ...
  _createClass(Ressources, [{
    ...
    value: function () {
      return {
        type: "WebApp.FakeApi.Ressources",
        interfaces: ["FSharpUnion", "System.IEquatable", "System.IComparable"],
        cases: {
          User: [UserRes]
        }
...
setType("WebApp.FakeApi.Ressources", Ressources);
function Get(x, cb, _genArgs) {
  var fire = function fire(x_1) {
    cb(x_1);
  };

  window.setTimeout(function (_arg1) {
    if (x.Fields[0].Case === "Index") {
      fire(db.GetAll({
        S: Types$$1.UserRecord
      }));
    }
...
var Model$7 = function () {
  function Model(users, isLoading) {
    _classCallCheck(this, Model);
  ...
  _createClass(Model, [{
    ...
    value: function () {
      return {
        type: "WebApp.Pages.User.Index.Model",
        interfaces: ["FSharpRecord", "System.IEquatable", "System.IComparable"],
        properties: {
          Users: makeGeneric(List$1, {
            T: Types$$1.UserRecord
          }),
          IsLoading: "boolean"
        }
      };
    ...
    key: "Initial",
    get: function () {
      return new Model(new List$1(), true);
    }
  }]);

  return Model;
}();
setType("WebApp.Pages.User.Index.Model", Model$7);
var Actions$7 = function () {
  ...
  _createClass(Actions, [{
    ...
    value: function () {
      return {
        type: "WebApp.Pages.User.Index.Actions",
        interfaces: ["FSharpUnion", "System.IEquatable", "System.IComparable"],
        cases: {
          Init: [],
          NavigateTo: [Route],
          NoOp: [],
          SetUsers: [makeGeneric(List$1, {
            T: Types$$1.UserRecord
          })],
          StopLoading: []
        }
...
setType("WebApp.Pages.User.Index.Actions", Actions$7);
function update$7(model, action) {
  if (action.Case === "Init") {
    var message = ofArray([function (h) {
      Get(new Ressources("User", [new UserRes("Index", [])]), function (data) {
        h(new Actions$7("SetUsers", [data]));
        h(new Actions$7("StopLoading", []));
      }, {
    ...
    return [model, message];
  } else if (action.Case === "SetUsers") {
    return [new Model$7(action.Fields[0], model.IsLoading), new List$1()];
  } else if (action.Case === "StopLoading") {
    return [function () {
      var IsLoading = false;
      return new Model$7(model.Users, IsLoading);
    }(), new List$1()];
  } else if (action.Case === "NavigateTo") {
    var _message = ofArray([function (h) {
      var url = resolveRoutesToUrl(action.Fields[0]);
...
var header = Tags.thead(new List$1())(ofArray([Tags.tr(new List$1())(ofArray([Tags.th(new List$1())(ofArray([Tags.text("Gender")])), Tags.th(new List$1())(ofArray([Tags.text("Firstname")])), Tags.th(new List$1())(ofArray([Tags.text("Surname")])), Tags.th(new List$1())(ofArray([Tags.text("Email")])), Tags.th(ofArray([Attributes.attribute("colspan", "2")]))(new List$1())]))]));

var bodyLoading = Tags.td(ofArray([Attributes.classy("has-text-centered"), Attributes.attribute("colspan", "6")]))(ofArray([Tags.i(ofArray([Attributes.classy("fa fa-spinner fa-spin")]))(new List$1())]));

var actionArea = Tags.div(ofArray([Attributes.classy("column is-2 is-offset-5")]))(ofArray([Tags.a(ofArray([Attributes.classy("button is-primary"), voidLinkAction(), Events.onMouseClick(function (_arg1) {
  return new Actions$7("NoOp", []);
})]))(ofArray([Tags.text("Create a user")]))]));
...
var Model$8 = function () {
  ...
  _createClass(Model, [{
    ...
    value: function () {
      return {
        type: "WebApp.Pages.User.Create.Model",
        interfaces: ["FSharpRecord", "System.IEquatable", "System.IComparable"],
        properties: {
          Value: "number"
        }
...
setType("WebApp.Pages.User.Create.Model", Model$8);
var Actions$8 = function () {
  ...
  _createClass(Actions, [{
    ...
    value: function () {
      return {
        type: "WebApp.Pages.User.Create.Actions",
        interfaces: ["FSharpUnion", "System.IEquatable", "System.IComparable"],
        cases: {
          ChangeFirtname: ["string"],
          NoOp: []
        }
      };
    }
...
setType("WebApp.Pages.User.Create.Actions", Actions$8);
function update$8(model, action) {
  if (action.Case === "ChangeFirtname") {
    console.log(action.Fields[0]);
    return [model, new List$1()];
  } else {
    return [model, new List$1()];
  }
...
var Model$9 = function () {
  ...
  _createClass(Model, [{
    ...
    value: function () {
      return {
        type: "WebApp.Pages.User.Edit.Model",
        interfaces: ["FSharpRecord", "System.IEquatable", "System.IComparable"],
        properties: {
          Value: "number"
        }
...
setType("WebApp.Pages.User.Edit.Model", Model$9);
var Actions$9 = function () {
  ...
  _createClass(Actions, [{
    ...
    value: function () {
      return {
        type: "WebApp.Pages.User.Edit.Actions",
        interfaces: ["FSharpUnion", "System.IEquatable", "System.IComparable"],
        cases: {
          NoOp: []
        }
...
setType("WebApp.Pages.User.Edit.Actions", Actions$9);
function update$9(model, action) {
  return [model, new List$1()];
}

var Model$10 = function () {
  function Model(value) {
    _classCallCheck(this, Model);
  ...
  _createClass(Model, [{
    ...
    value: function () {
      return {
        type: "WebApp.Pages.User.Show.Model",
        interfaces: ["FSharpRecord", "System.IEquatable", "System.IComparable"],
        properties: {
          Value: "number"
        }
...
setType("WebApp.Pages.User.Show.Model", Model$10);
var Actions$10 = function () {
  ...
  _createClass(Actions, [{
    ...
    value: function () {
      return {
        type: "WebApp.Pages.User.Show.Actions",
        interfaces: ["FSharpUnion", "System.IEquatable", "System.IComparable"],
        cases: {
          NoOp: []
        }
...
setType("WebApp.Pages.User.Show.Actions", Actions$10);
...
var AppApi = function (__exports) {
    ...
    var mapAppMessage = __exports.mapAppMessage = function (map$$1, _arg1) {
        return _arg1.Case === "Replay" ? new Types$2.AppMessage("Replay", [_arg1.Fields[0], map$1(function (tupledArg) {
            return [tupledArg[0], map$$1(tupledArg[1])];
        }, _arg1.Fields[1])]) : new Types$2.AppMessage("Message", [map$$1(_arg1.Fields[0])]);
    };
    ...
    var mapSubscriber = __exports.mapSubscriber = function (mapModelChanged, mapAction_1, sub, _arg1) {
        if (_arg1.Case === "ActionReceived") {
            (function (option) {
                ...
                if ($var7 != null) {
                    return function (arg0) {
                        return new Types$2.AppEvent("ActionReceived", [arg0]);
                    }($var7);
                } else {
                    return $var7;
                }
            ...
            if (_arg1.Case === "Replayed") {
                sub(new Types$2.AppEvent("Replayed", [_arg1.Fields[0]]));
            } else {
                (function (option) {
                    iterate(sub, function () {
                        var $var8 = option;
                    ...
                    if ($var9 != null) {
                        return function (arg0) {
                            return new Types$2.AppEvent("ModelChanged", [arg0]);
                        }($var9);
                    } else {
                        return $var9;
                    }
    ...
    var createApp = __exports.createApp = function (state, view, update, createRenderer) {
        return new Types$2.AppSpecification(state, view, update, function (_arg1) {}, createRenderer, "body", new List$1(), new List$1());
    };
    ...
    var withStartNodeSelector = __exports.withStartNodeSelector = function (selector, app) {
        return new Types$2.AppSpecification(app.InitState, app.View, app.Update, app.InitMessage, app.CreateRenderer, selector, app.Producers, app.Subscribers);
    };

    var withInitMessage = __exports.withInitMessage = function (msg, app) {
        return new Types$2.AppSpecification(app.InitState, app.View, app.Update, msg, app.CreateRenderer, app.NodeSelector, app.Producers, app.Subscribers);
    };

    var withInstrumentationProducer = function withInstrumentationProducer(p, app) {
        var Producers = new List$1(p, app.Producers);
        return new Types$2.AppSpecification(app.InitState, app.View, app.Update, app.InitMessage, app.CreateRenderer, app.NodeSelector, Producers, app.Subscribers);
    };
        ...
        var lift = function lift(h) {
            return function ($var10) {
                return h(function (arg0) {
                    return new Types$2.AppMessage("Message", [arg0]);
                }($var10));
            };
        };
    ...
    var withInstrumentationSubscriber = __exports.withInstrumentationSubscriber = function (subscriber, app) {
        ...
        return new Types$2.AppSpecification(app.InitState, app.View, app.Update, app.InitMessage, app.CreateRenderer, app.NodeSelector, app.Producers, Subscribers);
    };
    ...
    var start = __exports.start = function (appSpec) {
        var createInitApp = function createInitApp(post) {
            ...
            return new Types$2.App(appSpec.InitState, new List$1(), render, appSpec.Subscribers);
        };
        ...
        var handleMessage_ = function handleMessage_(post) {
            return function (notifySubs) {
                return function (message) {
                    return function (app) {
                        return Types$2.handleMessage(appSpec.Update, appSpec.View, post, notifySubs, message, app);
                    };
                };
            };
        };
        ...
        var handleReplay_ = function handleReplay_(post) {
            return function (notifySubs) {
                return function (tupledArg) {
                    return function (app) {
                        return Types$2.handleReplay(appSpec.View, appSpec.Update, post, notifySubs, tupledArg[0], tupledArg[1], app);
                    };
                };
            };
        };
        ...
        return Types$2.application(appSpec.InitMessage, handleMessage_, handleReplay_, configureProducers_, createInitApp);
    };
...
var Model$6 = function () {
  function Model$$1(index, create, edit, show) {
  ...
  _createClass(Model$$1, [{
    ...
    value: function () {
      return {
        type: "WebApp.Pages.User.Dispatcher.Model",
        interfaces: ["FSharpRecord", "System.IEquatable", "System.IComparable"],
        properties: {
          Index: Option(Model$7),
          Create: Option(Model$8),
          Edit: Option(Model$9),
          Show: Option(Model$10)
        }
      };
    }
  }, {
    ...
    key: "Generate",
    value: function (index, show, edit, create) {
      return new Model$$1(index, create, edit, show);
    }
  }, {
    key: "Initial",
    value: function (currentPage) {
      if (currentPage.Case === "Create") {
        return Model$$1.Generate(null, null, null, Model$8.Initial);
      } else if (currentPage.Case === "Edit") {
        return Model$$1.Generate(null, null, Model$9.Initial);
      } else if (currentPage.Case === "Show") {
        return Model$$1.Generate(null, Model$10.Initial);
      } else {
        return Model$$1.Generate(Model$7.Initial);
      }
    }
  }]);
...
setType("WebApp.Pages.User.Dispatcher.Model", Model$6);
var Actions$6 = function () {
  ...
  _createClass(Actions$$1, [{
    ...
    value: function () {
      return {
        type: "WebApp.Pages.User.Dispatcher.Actions",
        interfaces: ["FSharpUnion", "System.IEquatable", "System.IComparable"],
        cases: {
          CreateActions: [Actions$8],
          EditActions: [Actions$9],
          IndexActions: [Actions$7],
          ShowActions: [Actions$10]
        }
      };
    }
  }, {
...
setType("WebApp.Pages.User.Dispatcher.Actions", Actions$6);
function update$6(model, action) {
  if (action.Case === "CreateActions") {
    var _ret = function () {
      var patternInput = update$8(model.Create, action.Fields[0]);
      var action_ = AppApi.mapActions(function (arg0) {
        return new Actions$6("IndexActions", [arg0]);
      })(patternInput[1]);
      return {
        v: [function () {
          var Create = patternInput[0];
          return new Model$6(model.Index, Create, model.Edit, model.Show);
        }(), action_]
      };
    }();

    if ((typeof _ret === "undefined" ? "undefined" : _typeof(_ret)) === "object") return _ret.v;
  } else if (action.Case === "EditActions") {
    var _ret2 = function () {
      var patternInput = update$9(model.Edit, action.Fields[0]);
      var action_ = AppApi.mapActions(function (arg0) {
        return new Actions$6("EditActions", [arg0]);
      })(patternInput[1]);
      return {
        v: [function () {
          var Edit = patternInput[0];
          return new Model$6(model.Index, model.Create, Edit, model.Show);
        }(), action_]
      };
    }();

    if ((typeof _ret2 === "undefined" ? "undefined" : _typeof(_ret2)) === "object") return _ret2.v;
  } else if (action.Case === "ShowActions") {
    var _ret3 = function () {
      var patternInput = update$10(model.Show, action.Fields[0]);
      var action_ = AppApi.mapActions(function (arg0) {
        return new Actions$6("ShowActions", [arg0]);
      })(patternInput[1]);
      return {
        v: [function () {
          var Show = patternInput[0];
          return new Model$6(model.Index, model.Create, model.Edit, Show);
        }(), action_]
      };
    }();
    ...
    var patternInput = update$7(model.Index, action.Fields[0]);
    var action_ = AppApi.mapActions(function (arg0) {
      return new Actions$6("IndexActions", [arg0]);
    })(patternInput[1]);
    return [new Model$6(patternInput[0], model.Create, model.Edit, model.Show), action_];
  }
}
...
function from$3(comparer, tree) {
    var s = new FableSet();
    s.tree = tree;
    s.comparer = comparer || new GenericComparer();
    return s;
}
function create$7(ie, comparer) {
    comparer = comparer || new GenericComparer();
    return from$3(comparer, ie ? tree_ofSeq$1(comparer, ie) : new SetTree("SetEmpty", []));
}
    ...
    if (val == null) {
        ...
        switch (typ.kind) {
            ...
            case "GenericType":
                ...
                if (def === FableSet) {
                    return create$7(inflateArray(val, resolveGeneric(0, enclosing), path));
                }
                if (def === Set) {
                    return new Set(inflateArray(val, resolveGeneric(0, enclosing), path));
                }
                if (def === FableMap) {
                    return create$4(inflateMap(val, resolveGeneric(0, enclosing), resolveGeneric(1, enclosing), path));
                }
                if (def === Map) {
    ...
    return function (result) {
      if (lines_1.tail == null) {
        ...
        var newResult = function () {
          var activePatternResult932 = _Contains___("[BeginDocs]", lines_1.head);

          if (activePatternResult932 != null) {
            var line = activePatternResult932;
            ...
            var activePatternResult930 = _Contains___("[EndDocs]", lines_1.head);

            if (activePatternResult930 != null) {
              var _line = activePatternResult930;
              ...
              var activePatternResult928 = _IsBeginBlock___(lines_1.head);

              if (activePatternResult928 != null) {
                var groupName = activePatternResult928;
                ...
                var activePatternResult927 = _IsEndBlock___(lines_1.head);
                ...
                if (activePatternResult927 != null) {
                  ...
                  var activePatternResult922 = _IsBlock___(lines_1.head);

                  if (activePatternResult922 != null) {
                    var name = activePatternResult922;
                    return generateBlock(result, name, fsFormat("%s\n%s"));
                  } else {
                    var activePatternResult921 = _IsFsharpBlock___(lines_1.head);

                    if (activePatternResult921 != null) {
                      var _name = activePatternResult921;
...
setType("WebApp.Pages.Docs.Viewer.Model", Model$12);
var Actions$12 = function () {
  function Actions(caseName, fields) {
    _classCallCheck(this, Actions);
...
setType("WebApp.Pages.Docs.Viewer.Actions", Actions$12);
function update$12(model, action) {
  if (action.Case === "SetDocHTML") {
    ...
    return [new Model$12(model.CurrentFile, docs), new List$1()];
  } else {
    var exist = exists(function (x) {
    ...
    if (exist) {
      return [new Model$12(action.Fields[0], model.DocsHTML), new List$1()];
    } else {
      var m_ = new Model$12(action.Fields[0], new List$1(DocHTML.Initial(action.Fields[0]), model.DocsHTML));
      var message = ofArray([function (h) {
        _fetch(createDocFilesDirectoryURL(action.Fields[0]), {}).then(function (res) {
          return res.text();
        }).then(function (text) {
          return h(new Actions$12("SetDocHTML", [action.Fields[0], marked.parse(text)]));
        });
      }]);
      return [m_, message];
    }
...
var Model$11 = function () {
  ...
  _createClass(Model$$1, [{
    ...
    key: "Generate",
    value: function () {
      return new Model$$1(Model$12.Initial);
    }
  }, {
    key: "Initial",
    value: function (currentPage) {
...
setType("WebApp.Pages.Docs.Dispatcher.Model", Model$11);
var Actions$11 = function () {
  function Actions$$1(caseName, fields) {
    _classCallCheck(this, Actions$$1);
...
setType("WebApp.Pages.Docs.Dispatcher.Actions", Actions$11);
function update$11(model, action) {
  if (action.Case === "ViewerActions") {
    var patternInput = update$12(model.Viewer, action.Fields[0]);
    var action_ = AppApi.mapActions(function (arg0) {
      return new Actions$11("ViewerActions", [arg0]);
    })(patternInput[1]);
    return [new Model$11(patternInput[0]), action_];
  } else {
    return [model, new List$1()];
  }
}
...
setType("WebApp.Pages.Sample.Clock.Actions", Actions$14);
var Model$14 = function () {
...
setType("WebApp.Pages.Sample.Clock.Model", Model$14);
function update$14(model, action) {
  var patternInput = function () {
    ...
    return [new Model$14(format("{0:HH:mm:ss}", action.Fields[0]), date$$1), new List$1()];
  }();
...
setType("WebApp.Pages.Sample.Counter.Actions", Actions$15);
...
setType("WebApp.Pages.Sample.Counter.Model", Model$15);
function update$15(model, action) {
  if (action.Case === "Sub") {
    return [new Model$15(model.Value - 1), new List$1()];
  } else if (action.Case === "Reset") {
    return [new Model$15(0), new List$1()];
  } else {
    return [new Model$15(model.Value + 1), new List$1()];
  }
}
...
function sampleDemo$1(model) {
  return Tags.div(ofArray([Attributes.classy("columns is-vcentered")]))(ofArray([Tags.div(ofArray([Attributes.classy("column is-narrow"), new Types$1.Attribute("Style", [ofArray([["width", "170px"]])])]))(ofArray([Tags.text(fsFormat("Counter value: %i")(function (x) {
    return x;
  })(model.Value))])), simpleButton("+1", new Actions$15("Add", [])), simpleButton("-1", new Actions$15("Sub", [])), simpleButton("Reset", new Actions$15("Reset", []))]));
}
var docs$1 = new Documentation("Sample_Counter.fs");
function view$15(model) {
  ...
  _createClass(Actions$$1, [{
    ...
    value: function () {
      return {
        ...
        interfaces: ["FSharpUnion", "System.IEquatable", "System.IComparable"],
        cases: {
          CounterActions: ["number", Model$15, Actions$15],
          CreateCounter: [],
...
setType("WebApp.Pages.Sample.NestedCounter.Actions", Actions$16);
...
setType("WebApp.Pages.Sample.NestedCounter.Model", Model$16);
function update$16(model, action) {
  if (action.Case === "DeleteCounter") {
    var counters = filter$$1(function (tupledArg) {
      return tupledArg[0] !== action.Fields[0];
    }, model.Counters);
    return [new Model$16(counters, model.NextId), new List$1()];
    ...
    var message = ofArray([function (h) {
      ...
      try {
        for (var _iterator = _getIterator(model.Counters), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          ...
          h(new Actions$16("CounterActions", [forLoopVar[0], forLoopVar[1], new Actions$15("Reset", [])]));
        }
      } catch (err) {
        _didIteratorError = true;
        _iteratorError = err;
    ...
    var _ret = function () {
      var patternInput = update$15(action.Fields[1], action.Fields[2]);
      var mActions = AppApi.mapActions(function (tupledArg) {
        return new Actions$16("CounterActions", [tupledArg[0], tupledArg[1], tupledArg[2]]);
      })(patternInput[1]);
      ...
      return {
        v: [new Model$16(counters, model.NextId), mActions]
      };
    }();

    if ((typeof _ret === "undefined" ? "undefined" : _typeof(_ret)) === "object") return _ret.v;
  } else {
    return [new Model$16(append$$1(model.Counters, ofArray([[model.NextId, Model$15.Initial]])), model.NextId + 1), new List$1()];
  }
}
...
function sampleDemo$2(model) {
  ...
  return Tags.div(new List$1())(new List$1(Tags.div(ofArray([Attributes.classy("columns is-vcentered")]))(ofArray([VDom.Html.column(), simpleButton$1("Create a new counter", new Actions$16("CreateCounter", [])), simpleButton$1("Reset all", new Actions$16("ResetAll", [])), VDom.Html.column()])), countersView));
}
var docs$2 = new Documentation("Sample_NestedCounter.fs");
function view$16(model) {
  return VDom.Html.sampleView("Nested counter sample", sampleDemo$2(model), docs$2.Html);
}

var Actions$17 = function () {
  function Actions(caseName, fields) {
    _classCallCheck(this, Actions);
...
setType("WebApp.Pages.Sample.HelloWorld.Actions", Actions$17);
function update$17(model, action) {
  ...
  _createClass(Model$$1, [{
    ...
    value: function () {
      return {
        ...
        interfaces: ["FSharpRecord", "System.IEquatable", "System.IComparable"],
        properties: {
          Clock: Option(Model$14),
          Counter: Option(Model$15),
          HelloWorld: Option("string"),
          NestedCounter: Option(Model$16)
        }
      };
    }
  }, {
    ...
    value: function (currentPage) {
      if (currentPage.Case === "Counter") {
        return Model$$1.Generate(null, Model$15.Initial);
      } else if (currentPage.Case === "HelloWorld") {
        return Model$$1.Generate(null, null, "");
      } else if (currentPage.Case === "NestedCounter") {
        return Model$$1.Generate(null, null, null, Model$16.Initial);
      } else {
        return Model$$1.Generate(Model$14.Initial);
      }
    }
  }]);
...
setType("WebApp.Pages.Sample.Dispatcher.Model", Model$13);
  ...
  _createClass(Actions$$1, [{
    ...
    value: function () {
      return {
        ...
        interfaces: ["FSharpUnion", "System.IEquatable", "System.IComparable"],
        cases: {
          ClockActions: [Actions$14],
          CounterActions: [Actions$15],
          HelloWorldActions: [Actions$17],
          NavigateTo: [SampleApi.Route],
          NestedCounterActions: [Actions$16]
        }
      };
    }
  }, {
...
setType("WebApp.Pages.Sample.Dispatcher.Actions", Actions$13);
function update$13(model, action) {
  if (action.Case === "CounterActions") {
    var _ret = function () {
      var patternInput = update$15(model.Counter, action.Fields[0]);
      var action_ = AppApi.mapActions(function (arg0) {
        return new Actions$13("CounterActions", [arg0]);
      })(patternInput[1]);
      return {
        v: [function () {
          var Counter = patternInput[0];
          return new Model$13(model.Clock, Counter, model.HelloWorld, model.NestedCounter);
        }(), action_]
      };
    }();
    ...
    var _ret2 = function () {
      var patternInput = update$17(model.HelloWorld, action.Fields[0]);
      var action_ = AppApi.mapActions(function (arg0) {
        return new Actions$13("HelloWorldActions", [arg0]);
      })(patternInput[1]);
      return {
        v: [function () {
          var HelloWorld = patternInput[0];
          return new Model$13(model.Clock, model.Counter, HelloWorld, model.NestedCounter);
        }(), action_]
      };
    }();
    ...
    var _ret3 = function () {
      var patternInput = update$16(model.NestedCounter, action.Fields[0]);
      var action_ = AppApi.mapActions(function (arg0) {
        return new Actions$13("NestedCounterActions", [arg0]);
      })(patternInput[1]);
      return {
        v: [function () {
          var NestedCounter = patternInput[0];
          return new Model$13(model.Clock, model.Counter, model.HelloWorld, NestedCounter);
        }(), action_]
      };
    }();
    ...
    var patternInput = update$14(model.Clock, action.Fields[0]);
    var action_ = AppApi.mapActions(function (arg0) {
      return new Actions$13("ClockActions", [arg0]);
    })(patternInput[1]);
    return [new Model$13(patternInput[0], model.Counter, model.HelloWorld, model.NestedCounter), action_];
  }
}
function navItem$1(item, currentPage) {
  return Tags.a(ofArray([Attributes.classList(ofArray([["is-active", item.Route.Equals(currentPage)], ["nav-item is-tab", true]])), voidLinkAction(), Events.onMouseClick(function (_arg1) {
    return new Actions$13("NavigateTo", [item.Route]);
...
function view$13(model, subRoute) {
  var htmlContent = subRoute.Case === "Counter" ? map$$1(function (arg0) {
    return new Actions$13("CounterActions", [arg0]);
  }, view$15(model.Counter)) : subRoute.Case === "HelloWorld" ? map$$1(function (arg0) {
    return new Actions$13("HelloWorldActions", [arg0]);
  }, view$17(model.HelloWorld)) : subRoute.Case === "NestedCounter" ? map$$1(function (arg0) {
    return new Actions$13("NestedCounterActions", [arg0]);
  }, view$16(model.NestedCounter)) : map$$1(function (arg0) {
    return new Actions$13("ClockActions", [arg0]);
  }, view$14(model.Clock));
...
var from$5 = _core.Array.from;

var from$4 = createCommonjsModule(function (module) {
module.exports = { "default": from$5, __esModule: true };
});
          ...
          return [function (a) {
            ...
            return function (a) {
              return function (_arg9) {
                ...
                var $var2 = _arg1_1[0](a);

                if ($var2 != null) {
                  return _arg2[1](c)($var2);
                } else {
                  return $var2;
                }
              }());
  ...
  var _Map = __exports.Map = function (__exports) {
    ...
    var array_ = __exports.array_ = function () {
      return [function (table) {
        ...
        return create$4(elements, new GenericComparer(function (x, y) {
...
var SubModels = function () {
  function SubModels(navbar$$1, header, menu, index, about, user, docs$$1, sample) {
  ...
  _createClass(SubModels, [{
    ...
    value: function () {
      return {
        ...
        properties: {
          ...
          Header: Model$2,
          Menu: Model$3,
          Index: Option(Model$4),
          About: Option(Model$5),
          User: Option(Model$6),
          Docs: Model$11,
          Sample: Option(Model$13)
        }
      };
    }
  }, {
    ...
    key: "Initial",
    get: function () {
      return new SubModels(Model$1.Initial(new Route("Index", [])), Model$2.Initial(new Route("Index", [])), Model$3.Initial(new Route("Index", [])), null, null, null, Model$11.Initial(new DocsApi.Route("Index", [])), null);
    }
  }, {
    key: "Index_",
    get: function () {
      return [function (r) {
        ...
        return function (r) {
          var Index = v;
          return new SubModels(r.Navbar, r.Header, r.Menu, Index, r.About, r.User, r.Docs, r.Sample);
        };
      }];
    }
  }, {
    ...
    get: function () {
      return [function (r) {
        ...
        return function (r) {
          return new SubModels(r.Navbar, v, r.Menu, r.Index, r.About, r.User, r.Docs, r.Sample);
        };
      }];
    }
  }, {
    ...
    get: function () {
      return [function (r) {
        ...
        return function (r) {
          var About = v;
          return new SubModels(r.Navbar, r.Header, r.Menu, r.Index, About, r.User, r.Docs, r.Sample);
        };
      }];
    }
  }, {
    ...
    get: function () {
      return [function (r) {
        ...
        return function (r) {
          var User = v;
          return new SubModels(r.Navbar, r.Header, r.Menu, r.Index, r.About, User, r.Docs, r.Sample);
        };
      }];
    }
  }, {
    ...
    get: function () {
      return [function (r) {
        ...
        return function (r) {
          return new SubModels(r.Navbar, r.Header, r.Menu, r.Index, r.About, r.User, v, r.Sample);
        };
      }];
    }
  }, {
    ...
    get: function () {
      return [function (r) {
        ...
        return function (r) {
          var Sample = v;
          return new SubModels(r.Navbar, r.Header, r.Menu, r.Index, r.About, r.User, r.Docs, Sample);
        };
      }];
    }
  }, {
    ...
    get: function () {
      return [function (r) {
        ...
        return function (r) {
          return new SubModels(v, r.Header, r.Menu, r.Index, r.About, r.User, r.Docs, r.Sample);
        };
      }];
    }
  }, {
    ...
    get: function () {
      return [function (r) {
        ...
        return function (r) {
          return new SubModels(r.Navbar, r.Header, v, r.Index, r.About, r.User, r.Docs, r.Sample);
        };
      }];
    }
  }]);
  ...
  _createClass(Actions$$1, [{
    ...
    value: function () {
      return {
        ...
        interfaces: ["FSharpUnion", "System.IEquatable", "System.IComparable"],
        cases: {
          AboutActions: [Actions$5],
          DocsDispatcherAction: [Actions$11],
          HeaderActions: [Actions$2],
          IndexActions: [Actions$4],
          MenuActions: [Actions$3],
          NavbarActions: [Actions$1],
          NavigateTo: [Route],
          NoOp: [],
          SampleDispatcherAction: [Actions$13],
          UserDispatcherAction: [Actions$6]
        }
      };
    }
  }, {
...
function update$$1(model, action) {
  if (action.Case === "IndexActions") {
    var patternInput = update$4(model.SubModels.Index, action.Fields[0]);
    var action_ = AppApi.mapActions(function (arg0) {
      return new Actions$$1("IndexActions", [arg0]);
    })(patternInput[1]);
    ...
    }(new Compose.Lens("Lens", []))(SubModels.Index_)(Model$$1.SubModels_))(patternInput[0])(model);

    return [m_, action_];
  } else if (action.Case === "AboutActions") {
    var _patternInput = update$5(model.SubModels.About, action.Fields[0]);

    var _action_ = AppApi.mapActions(function (arg0) {
      return new Actions$$1("AboutActions", [arg0]);
    })(_patternInput[1]);
    ...
    }(new Compose.Lens("Lens", []))(SubModels.About_)(Model$$1.SubModels_))(_patternInput[0])(model);

    return [_m_, _action_];
  } else if (action.Case === "UserDispatcherAction") {
    var _patternInput2 = update$6(model.SubModels.User, action.Fields[0]);

    var _action_2 = AppApi.mapActions(function (arg0) {
      return new Actions$$1("UserDispatcherAction", [arg0]);
    })(_patternInput2[1]);
    ...
    }(new Compose.Lens("Lens", []))(SubModels.User_)(Model$$1.SubModels_))(_patternInput2[0])(model);

    return [_m_2, _action_2];
  } else if (action.Case === "DocsDispatcherAction") {
    var _patternInput3 = update$11(model.SubModels.Docs, action.Fields[0]);
    ...
    }(new Compose.Lens("Lens", []))(SubModels.Docs_)(Model$$1.SubModels_))(_patternInput3[0])(model);
    ...
    if (function () {
      ...
      var _patternInput4 = update$13(model.SubModels.Sample, action.Fields[0]);

      var _action_4 = AppApi.mapActions(function (arg0) {
      ...
      }(new Compose.Lens("Lens", []))(SubModels.Sample_)(Model$$1.SubModels_))(_patternInput4[0])(model);

      return [_m_4, _action_4];
    } else {
      return [model, new List$1()];
    }
  } else if (action.Case === "MenuActions") {
    var _patternInput5 = update$3(model.SubModels.Menu, action.Fields[0]);

    var _action_5 = AppApi.mapActions(function (arg0) {
      return new Actions$$1("MenuActions", [arg0]);
    })(_patternInput5[1]);
    ...
    }(new Compose.Lens("Lens", []))(SubModels.Menu_)(Model$$1.SubModels_))(_patternInput5[0])(model);

    return [_m_5, _action_5];
  } else if (action.Case === "NavbarActions") {
    var _patternInput6 = update$1(model.SubModels.Navbar, action.Fields[0]);

    var _action_6 = AppApi.mapActions(function (arg0) {
    ...
    }(new Compose.Lens("Lens", []))(SubModels.Navbar_)(Model$$1.SubModels_))(_patternInput6[0])(model);

    return [_m_6, _action_6];
  } else if (action.Case === "HeaderActions") {
    var _patternInput7 = update$2(model.SubModels.Header, action.Fields[0]);

    var _action_7 = AppApi.mapActions(function (arg0) {
    ...
    }(new Compose.Lens("Lens", []))(SubModels.Header_)(Model$$1.SubModels_))(_patternInput7[0])(model);

    return [_m_7, _action_7];
  } else if (action.Case === "NoOp") {
    return [model, new List$1()];
  } else if (action.Fields[0].Case === "About") {
    var _m_8 = function (arg0) {
      return function (arg1) {
        return Optic.Set.op_HatEquals_0(arg0, arg1);
      };
    ...
    }(new Compose.Lens("Lens", []))(Model$3.CurrentPage_)(function (arg0) {
      return function (arg1) {
        return Compose.Lens.op_GreaterMinusGreater_0(arg0, arg1);
      };
    }(new Compose.Lens("Lens", []))(SubModels.Menu_)(Model$$1.SubModels_)))(action.Fields[0])(function (arg0) {
      return function (arg1) {
        return Optic.Set.op_HatEquals_0(arg0, arg1);
      };
    }(new Optic.Set("Set", []))(function (arg0) {
    ...
    }(new Compose.Lens("Lens", []))(SubModels.About_)(Model$$1.SubModels_))(Model$5.Initial)(model)))));

    return [_m_8, new List$1()];
  } else if (action.Fields[0].Case === "Docs") {
    var _m_9 = function (arg0) {
      return function (arg1) {
        return Optic.Set.op_HatEquals_0(arg0, arg1);
      };
    }(new Optic.Set("Set", []))(Model$$1.CurrentPage_)(action.Fields[0])(function (arg0) {
    ...
    var message = action.Fields[0].Fields[0].Case === "Viewer" ? ofArray([function (h) {
      h(new Actions$$1("DocsDispatcherAction", [new Actions$11("ViewerActions", [new Actions$12("SetDoc", [action.Fields[0].Fields[0].Fields[0]])])]));
    }]) : new List$1();
    return [_m_9, message];
  } else if (action.Fields[0].Case === "Sample") {
    var _m_10 = function (arg0) {
      return function (arg1) {
        return Optic.Set.op_HatEquals_0(arg0, arg1);
      };
    }(new Optic.Set("Set", []))(Model$$1.CurrentPage_)(action.Fields[0])(function (arg0) {
    ...
    }(new Compose.Lens("Lens", []))(SubModels.Sample_)(Model$$1.SubModels_))(Model$13.Initial(action.Fields[0].Fields[0]))(model)))));

    return [_m_10, new List$1()];
  } else {
    var _m_11 = function (arg0) {
      return function (arg1) {
        return Optic.Set.op_HatEquals_0(arg0, arg1);
      };
    }(new Optic.Set("Set", []))(Model$$1.CurrentPage_)(action.Fields[0])(function (arg0) {
    ...
    }(new Compose.Lens("Lens", []))(SubModels.Index_)(Model$$1.SubModels_))(Model$4.Initial)(model)))));

    return [_m_11, new List$1()];
  }
}
function view$$1(model) {
  var pageHtml = model.CurrentPage.Case === "Docs" ? map$$1(function (arg0) {
    return new Actions$$1("DocsDispatcherAction", [arg0]);
  }, view$11(model.SubModels.Docs, model.CurrentPage.Fields[0])) : model.CurrentPage.Case === "Sample" ? map$$1(function (arg0) {
    return new Actions$$1("SampleDispatcherAction", [arg0]);
  }, view$13(model.SubModels.Sample, model.CurrentPage.Fields[0])) : model.CurrentPage.Case === "About" ? map$$1(function (arg0) {
    return new Actions$$1("AboutActions", [arg0]);
  }, view$5(model.SubModels.About)) : map$$1(function (arg0) {
    return new Actions$$1("IndexActions", [arg0]);
  }, view$4(model.SubModels.Index));
  var navbarHtml = map$$1(function (arg0) {
    return new Actions$$1("NavbarActions", [arg0]);
  }, view$1(model.SubModels.Navbar));
  var menuHtml = map$$1(function (arg0) {
    return new Actions$$1("MenuActions", [arg0]);
  }, view$3(model.SubModels.Menu));
...
var routes = ofArray([function () {
  ...
  var route = function ($var9) {
    return Parsing._end(Parsing.drop($var9));
  ...
  var route = function ($var10) {
    return Parsing._end(Parsing.drop($var10));
  ...
  var route = function ($var11) {
    return Parsing._end(Parsing.drop($var11));
  ...
  var route = function ($var12) {
    return Parsing._end(Parsing.drop($var12));
  ...
  var route = function ($var13) {
    return Parsing._end(Parsing.drop($var13));
  ...
  var route = function ($var14) {
    return Parsing._end(Parsing.drop($var14));
...
function tickProducer(push) {
  window.setInterval(function (_arg1) {
    push(new Actions$$1("SampleDispatcherAction", [new Actions$13("ClockActions", [new Actions$14("Tick", [now()])])]));
    return null;
  }, 1000);
  push(new Actions$$1("SampleDispatcherAction", [new Actions$13("ClockActions", [new Actions$14("Tick", [now()])])]));
}
